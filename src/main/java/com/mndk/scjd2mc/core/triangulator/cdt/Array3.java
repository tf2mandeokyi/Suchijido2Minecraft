...
public class Array3<T> implements List<T> {
	...
	public ListIterator<T> listIterator() {
		return new Array3ListIterator<>(this, 0);
	}
	...
	public ListIterator<T> listIterator(int index) {
		return new Array3ListIterator<>(this, index);
	}
	...
	public List<T> subList(int s, int e) {
		...
		if(s >= 0) {
			if(e == 1) return Collections.singletonList(e1);
			if(e == 2) return Arrays.asList(e1, e2);
			return Arrays.asList(e1, e2, e3);
		}
		if(s == 1) {
			if(e == 2) return Collections.singletonList(e2);
